...
const MESSAGES = {
  ...
  error_download_image:
    "We couldn't retrieve your photo to analyze it. Please try again.",
  InvalidParameters:
    "Something went wrong preparing your analysis request. Please try again.",
  // Simulation uses its own snake_case spelling for the same class of error.
  error_invalid_params:
    "Something went wrong preparing your simulation request. Please try again.",
};
